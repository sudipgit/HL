<?php
/**
 * Plugin Name: WooCommerce Custom Product Tabs Lite1
 ...
 *
 * @package     WC-Custom-Product-Tabs-Lite1
 * @author      SkyVerge
 * @category    Plugin
...
if ( ! WoocommerceCustomProductTabsLite1::is_woocommerce_active() )
	return;

/**
 * The WoocommerceCustomProductTabsLite1 global object
 * @name $woocommerce_product_tabs_lite
 * @global WoocommerceCustomProductTabsLite1 $GLOBALS['woocommerce_product_tabs_lite']
 */
$GLOBALS['woocommerce_product_tabs_lite'] = new WoocommerceCustomProductTabsLite1();

class WoocommerceCustomProductTabsLite1 {
	...
	public function product_write_panel() {
		...
		foreach ( $tab_data as $tab ) {
			...
			woocommerce_wp_text_input( array( 'id' => '_wc_custom_product_tabs_lite_tab_title1', 'label' => __( 'Tab Title' ), 'description' => __( 'Required for tab to be visible' ), 'value' => $tab['title'] ) );
			$this->woocommerce_wp_textarea_input( array( 'id' => '_wc_custom_product_tabs_lite_tab_content1', 'label' => __( 'Content' ), 'placeholder' => __( 'HTML and text to display.' ), 'value' => $tab['content'], 'style' => 'width:70%;height:21.5em;' ) );
			echo '</div>';
		}
	}
	...
	public function product_save_data( $post_id, $post ) {
		...
		$tab_title = stripslashes( $_POST['_wc_custom_product_tabs_lite_tab_title1'] );
		$tab_content = stripslashes( $_POST['_wc_custom_product_tabs_lite_tab_content1'] );
