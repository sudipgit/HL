												...
												<table>
													<tbody>
														...
														<tr>
															...
															<td class="right"><?php _e('Scale', 'LayerSlider') ?></td>
															<td><input type="text" name="scalein" value="<?php echo ($sublayer['scalein'] != '') ? $sublayer['scalein'] : '1.0' ?>" class="sublayerprop" data-help="You can set the initial scale of this layer here which will be animated to the default (1.0) value."></td>
															<td class="right"></td>
															<td></td>
															<td class="right"></td>
															<td></td>
														...
														<tr>
															...
															<td class="right"><?php _e('Scale', 'LayerSlider') ?></td>
															<td><input type="text" name="scaleout" value="<?php echo ($sublayer['scaleout'] != '') ? $sublayer['scaleout'] : '1.0' ?>" class="sublayerprop" data-help="You can set the ending scale value here, this sublayer will be animated from the default (1.0) value to yours."></td>
															<td class="right"></td>
															<td></td>
															<td class="right"></td>
															<td></td>
											...
											<div class="ls-sublayer-page ls-sublayer-link">
												<table>
													<tbody>
														<tr>
															<td><?php _e('URL', 'LayerSlider') ?></td>
															<td class="url"><input type="text" name="url" value="<?php echo $sublayer['url'] ?>" data-help="<?php _e('If you want to link your layer, type here the URL.', 'LayerSlider') ?>"></td>
															<td>
																<select name="target" data-help="<?php _e('You can control here the link behaviour: _self means the linked page will open in the current tab/window, _blank will open it in a new tab/window.', 'LayerSlider') ?>">
