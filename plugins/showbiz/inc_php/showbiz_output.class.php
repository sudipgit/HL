		...
		public function putSliderBase($sliderID){
			...
			try{
				...
				if($this->slider->getParam("js_to_body","false") == "true"){
					...
					//include showbiz js
					$urlIncludeJS = UniteBaseClassBiz::$url_plugin."showbiz-plugin/js/jquery.themepunch.plugins.min.js?rev=". GlobalsRevSlider::SLIDER_REVISION;					
					$htmlBeforeSlider .= "<script type='text/javascript' src='$urlIncludeJS'></script>";
					$urlIncludeJS = UniteBaseClassBiz::$url_plugin."showbiz-plugin/js/jquery.themepunch.showbizpro.min.js?rev=". GlobalsRevSlider::SLIDER_REVISION;					
					$htmlBeforeSlider .= "<script type='text/javascript' src='$urlIncludeJS'></script>";
					
					//include fancybox js
					if(GlobalsShowBiz::INCLUDE_FANCYBOX){
						$urlIncludeFancybox = UniteBaseClassBiz::$url_plugin."showbiz-plugin/fancybox/jquery.fancybox.pack.js?rev=". GlobalsRevSlider::SLIDER_REVISION;					
						$htmlBeforeSlider .= "<script type='text/javascript' src='$urlIncludeFancybox'></script>";
						
						$urlIncludeFancybox = UniteBaseClassBiz::$url_plugin."showbiz-plugin/fancybox/helpers/jquery.fancybox-media.js?rev=". GlobalsRevSlider::SLIDER_REVISION;					
						$htmlBeforeSlider .= "<script type='text/javascript' src='$urlIncludeFancybox'></script>";
					}
				}
