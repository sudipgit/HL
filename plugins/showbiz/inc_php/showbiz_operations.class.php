			...
			?>
				<html>
					<head>
						...
						<link rel='stylesheet' href='<?php echo $urlPlugin?>fancybox/jquery.fancybox.css?rev=<?php echo GlobalsRevSlider::SLIDER_REVISION; ?>' type='text/css' media='all' />

						<script type='text/javascript' src='http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js'></script>
						<script type='text/javascript' src='<?php echo $urlPlugin?>fancybox/jquery.fancybox.pack.js?rev=<?php echo GlobalsRevSlider::SLIDER_REVISION; ?>'></script>
						...
						<script type='text/javascript' src='<?php echo $urlPlugin?>js/jquery.themepunch.showbizpro.min.js?rev=<?php echo  GlobalsRevSlider::SLIDER_REVISION; ?>'></script>
					</head>
