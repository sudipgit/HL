				...
				?>
					<li id="slidelist_item_<?php echo $slideid?>" class="ui-state-default">
						...
						<span class="slide-col col-image">
							...
							<div id="slide_image_<?php echo $postID?>" class="slide_image" title="Click to change the slide image." alt="<?php echo $imageAlt?>" style="background-image:url('<?php echo $urlImageForView?>')"></div>
						...
						<span class="slide-col col-operations">
							...
							<a id="button_duplicate_slide_<?php echo $slideid?>" class='button-primary revyellow button_duplicate_slide' href='javascript:void(0)' style="width:120px; " ><i class="revicon-picture"></i><?php _e("Duplicate",REVSLIDER_TEXTDOMAIN)?></a>							
						</span>
