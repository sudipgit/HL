...
<?php echo $api?>.bind("showbiz.slide.onloaded",function (e) {
	//alert("slider loaded");
});
		
<?php echo $api?>.bind("showbiz.slide.onchange",function (e,data) {
	//alert("slide changed to: "+data.slideIndex);
});

<?php echo $api?>.bind("showbiz.slide.onpause",function (e,data) {
	//alert("timer paused");
});

<?php echo $api?>.bind("showbiz.slide.onresume",function (e,data) {
	//alert("timer resume");
});

<?php echo $api?>.bind("showbiz.slide.onvideoplay",function (e,data) {
	//alert("video play");
});

<?php echo $api?>.bind("showbiz.slide.onvideostop",function (e,data) {
	//alert("video stopped");
});

<?php echo $api?>.bind("showbiz.slide.onstop",function (e,data) {
	//alert("slider stopped");
});

<?php echo $api?>.bind("showbiz.slide.onbeforeswap",function (e) {
	//alert("before swap");
});

<?php echo $api?>.bind("showbiz.slide.onafterswap",function (e) {
	//alert("after swap");
});
