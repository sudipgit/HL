...
$(function()
{
	...
	{
		$.getJSON('http://myhypehair.com/morgandemo/wp-content/themes/456shop/brand-admin/common/theme/scripts/plugins/maps/jvectormap/data/us-unemployment.json', function(data){
			var val = 2009;
