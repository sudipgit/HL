...
<?php
   ...
   if($_POST['is_submit'])
   {
      if($_POST['product_id']>0)
	  {
		  ...
		  if(saveEditProduct($_POST,$_FILES))
		  {?>
	 ...
	 else if(saveProductPost($_POST,$_FILES))  //Source: ../../functions/products.php
	  {
	  ?>
...
//Return All information of a given product id
 $product=getProductDetailInfo($pid);

if($product)
if($product->post_author!=$current_user->ID && $current_user->ID!=1)
  $product=null;
...
<h3 class="brand-dashboard-title add-product-title"><span><?php if($pid) echo 'Update Product'; else echo 'Add New Product';?></span></h3>
			...
			<div class="tab-content">
				...
				<div class="row-fluid">
		           <div class="span3">
		            ...
		            <div class="span9">
			          <label><input type="radio" value="yes" name="is_organic" <?php if($product->is_organic=="yes") echo 'checked="checked"';?>/> Yes </label>
			          <label><input type="radio" value="no" name="is_organic"  <?php if($product->is_organic=="no") echo 'checked="checked"';?>/>  No</label>
						...
						<div class="span9">
						 ...
						 <label><input id="type_of_product9" type="radio" name="type_of_product"  value="s_relaxer" <?php if($product->type_of_product=="s_relaxer") echo 'checked="checked"';?>>Relaxer/Straightening Treatment</label>
						  <label><input id="type_of_product9" type="radio" name="type_of_product" value="s_texture" <?php if($product->type_of_product=="s_texture") echo 'checked="checked"';?>>Texturizer </label>
						   ...
						   <label><input id="type_of_product91" type="radio" name="type_of_product" value="s_art_tools" <?php if($product->type_of_product=="s_art_tools") echo 'checked="checked"';?>>Hair Art Tools </label>
						    <label><input id="type_of_product92" type="radio" name="type_of_product" value="s_hair_loss" <?php if($product->type_of_product=="s_hair_loss") echo 'checked="checked"';?>>Hair Loss </label>
						</div>
						<!-- // Column END -->
		       ...
		       if($product)
		           ...
		           ?>
						...
						<!-- Column -->
						<div class="span9">
						     <label><input id="type_of_hair1"  class="selectedId9" type="checkbox" name="type_of_hair[]" value="c_ns" <?php if($product) echo 'checked="checked"';?>>
							Naturally Straight
                             </label>
