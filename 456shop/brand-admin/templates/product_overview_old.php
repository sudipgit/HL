...
include_once('functions.php');
				      ...
				      if($pid<1 && $products)
						...
						$answers=getMyCustomers($current_user->ID,$pid);
						$customers=getMyCustomerIds($current_user->ID,$pid);
				$product_info=getProductDetailInfo($pid);
				
				$brand= get_brand_info($product_info->post_author);
         if($brand->thumb=="")
              $thumbpath='http://myhypehair.com/123456789/wp-content/uploads/brandphoto/thumb.png';
	     else
	         $thumbpath='http://myhypehair.com/123456789/wp-content/uploads/brandphoto/'.$brand->user_id.'/'.$brand->thumb;
?>
...
<!-- Filters -->
			...
			<div class="filter-bar">
				<form action="<?php bloginfo('url'); ?>/product-overview/" method="get" name="option-form">
				   <!-- Filter -->
					<div>
...
<div class="span7 product-image">
	...
	<div class="title-price">
		<h4 itemprop="name" class="product_title entry-title"><?php echo $product_info->post_title;?> <span class="amount">&#36;<?php echo $product_info->price;?></h4>
...
<P><?php echo $product_info->ingredients;?>	</p>
			    ...
			    <div class="single-social-bar social-md-bar">
			     <p class="share-text">Share</p>
				<div class="media-bar">
				<ul>
				 <li>
			         <a class="facebook" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo get_permalink($product_info->ID);?>">Facebook</a>
				</li>
				<li>
				<a class="twitter" target="_blank" href="http://twitter.com/share?url=<?php echo get_permalink($product_info->ID);?>">twitter
				</a>
				</li>
				<li>
				<a class="pinterest" target="_blank" href="http://www.pinterest.com/hairlibrary/">pinterest
				</a>
				</li>
		
				<li>
				<a class="googleplus" target="_blank" href="https://plus.google.com/share?url=<?php echo get_permalink($product_info->ID);?>">Googleplus
				</a>
				</li>
	...
	<div class="span5">
	     ...
	     <div class="brand-logo">
		   <img alt="profile" src="<?php echo $thumbpath;?>" width="130"/>
		 </div>
		 <div class="brand-des">
		  <h4> <?php echo $brand->company_name;?> </h4>
		 <p>
          <?php echo $brand->overview;?> 
		   </p>
		    <p>Website: <a href="<?php echo $brand->company_website;?>"><?php echo $brand->company_website;?></a> </p>
		   <p class="align-right"><a href="<?php bloginfo('url'); ?>/brand?id=<?php echo $brand->user_id;?>">More From <?php echo $brand->company_name;?></a></p>
		...
		<div class="tab-pane innerAll active" id="tab-chat">
			<div class="box-generic widget-chat">
				...
				<div class="slim-scroll chat-items" data-scroll-height="240px">
					...
					<!-- Media item -->
					<div class="media">
						<div class="media-object pull-left thumb"><img src="<?php bloginfo('template_url');?>/brand-admin/images/ProfilePhotos.jpg" width="80" alt="ProfilePhotos"></div>
					...
					<!-- Media item -->
					<div class="media">
						<div class="media-object pull-right thumb"><img src="<?php bloginfo('template_url');?>/brand-admin/images/photo.jpg" width="80" alt="photo"></div>
					...
					<!-- Media item -->
					<div class="media">
						<div class="media-object pull-left thumb"><img src="<?php bloginfo('template_url');?>/brand-admin/images/jpg54271x300.jpg" width="80" alt="jpg54271x300"></div>
						<div class="media-body">
							<blockquote>
	 ...
	 <div class="widget">
		...
		<div class="widget-body">
	      <div class="span2 <?php if(!in_array('weave',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Weave" class="widget-stats small margin-bottom-none">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'weave',$answers);?></span>
						</a>
						<p><span> Weave</span></p>
						<!-- // Stats Widget END -->
					...
					<div class="span2 <?php if(!in_array('r_s_hair',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Relaxed Straight Hair" class="widget-stats small margin-bottom-none">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'r_s_hair',$answers);?></span>
						</a>
					...
					<div class="span2 <?php if(!in_array('braids',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Braids" class="widget-stats small">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'braids',$answers);?></span>
						</a>
		           ...
		           <div class="span2 <?php if(!in_array('wigs',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Wigs" class="widget-stats small">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'wigs',$answers);?></span>
						</a>
						<p><span> Wigs</span></p>
						<!-- // Stats Widget END -->
		...
		<div class="span2 <?php if(!in_array('dreds',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Dreds" class="widget-stats small">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'dreds',$answers);?></span>
						</a>
						<p><span> Dreds</span></p>
						<!-- // Stats Widget END -->
			...
			<div class="span2 <?php if(!in_array('p_t_hair',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Permed/Texturized Hair" class="widget-stats small">
							<img alt="Permed/Texturized Hair" src="<?php bloginfo('template_url'); ?>/brand-admin/images/hair_style/texturized_permed_curly.jpg"/>
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'p_t_hair',$answers);?></span>
						</a>
					...
					<div class="span2 <?php if(!in_array('n_c_hair',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Naturally Curly Hair" class="widget-stats small">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'n_c_hair',$answers);?></span>
						</a>
					...
					<div class="span2 <?php if(!in_array('nt_st_hair',$hss)) echo 'no_apply';?>">
						...
						<a href="" title="Naturally Straight Hair" class="widget-stats small">
							...
							<span class="count label label-primary"><?php echo get_user_ans_count(9,'nt_st_hair',$answers);?></span>
						</a>
...
arrlength2= [
   ...
   arrtex2 =[
		...
		arrhsty2 =[
		    { label: "Weave",  data: <?php echo get_user_ans_count(9,'weave',$answers);?> },
		    { label: "Relaxed Straight Hair",  data: <?php echo get_user_ans_count(9,'r_s_hair',$answers);?> },
		    { label: "Braids",  data: <?php echo get_user_ans_count(9,'braids',$answers);?> },
		    { label: "Wigs",  data: <?php echo get_user_ans_count(9,'wigs',$answers);?> },
		    { label: "Dreds",  data: <?php echo get_user_ans_count(9,'dreds',$answers);?> },
		    { label: "Permed/Texturized Hair",  data: <?php echo get_user_ans_count(9,'p_t_hair',$answers);?> },
			{ label: "Naturally Curly Hair",  data: <?php echo get_user_ans_count(9,'n_c_hair',$answers);?> },
			{ label: "Naturally Straight Hair",  data: <?php echo get_user_ans_count(9,'nt_st_hair',$answers);?> }
		];
