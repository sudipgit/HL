...
$userid=$user->ID;
 ...
 if(isset($_POST['quick_match_submit'])){
 
     $answers=array();
	 $answers[3] = $_POST['cat'];
	$answers[5] = $_POST['hairLenth'];
	$answers[4] = $_POST['hairTex'];
	$answers[8] = $_POST['hairProc'];
	//$answers['haircolor'] = $_POST['haircolor'];
	$answers[7] = $_POST['hairCond'];
	$answers[6] = $_POST['hairDes'];
	//$answers['hairWear'] = $_POST['hairWear'];
	 $_SESSION['quick_match_answer'] = $answers;

 }
 
 $answers= $_SESSION['quick_match_answer'];
...
?>
 ...
 <link href="<?php bloginfo('template_url'); ?>/brand-admin/css/custom.css" rel="stylesheet" />	
		<div id="main" class="wrap post-template edit-profile quick-match">
			<div class="container">					 
...
<form name="hair_style" action="" method="post" onsubmit="return fromValidation();">
...
<div class="section">
				 <h3  class="hair-type">The Following Best Describes My Hair As...</h3>
				   <div class="question-images panel">
				     <ul class="d-hair-des">
					  <li>
					  <a class="<?php if($answers){ if($answers['6']=='coarse') echo 'active';}?>" href="javascript:void();" title="coarse">Coarse</a>
					  </li>
					   <li >
					  <a class="<?php if($answers){ if($answers['6']=='soft') echo 'active';}?>" href="javascript:void();" title="soft">Soft</a>
					  </li>
					   <li >
					  <a class="<?php if($answers){ if($answers['6']=='fine') echo 'active';}?>" href="javascript:void();" title="fine">Fine</a>
					  </li>
					   <li >
					  <a class="<?php if($answers){ if($answers['6']=='thin') echo 'active';}?>" href="javascript:void();" title="thin">Thin</a>
					  </li>
					 <div class="clearfix"></div>
					</ul>
					<div class="clear"></div>
...
<div class="section">
				 ...
				 <input id="d-hair-style-value" type="hidden" name="cat" value="<?php echo $answers['3'];?>"/>
				   ...
				   <input id="d-hair-des-value" type="hidden" name="hairDes" value="<?php echo $answers['6'];?>"/>
					...
					<input type="submit" name="quick_match_submit" value="Get Matches" class="button"/>
			...
			$matches=getQuickMatchingProducts($answers);
			//Source: functions/products.php
             $matches=fillterMatches($matches,null,$hccat);
			?>
			
				<?php if($matches) {?>
				<div class="sectionf matches">
                    <h3 class="title">My Matches</h3>
					<div class="product_nav">
								<ul>
									<li <?php if(!$hccat) echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/">ALL</a></li>
									<li <?php if($hccat=='s_c') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_c">Conditioner</a></li>
									<li <?php if($hccat=='s_s') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_s">Shampoo</a></li>
									<li <?php if($hccat=='s_o') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_o">Oil</a></li>
									<li <?php if($hccat=='s_g') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_g">Gel</a></li>
									<li <?php if($hccat=='s_mt') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_mt">Moisturiser</a></li>
									<li <?php if($hccat=='s_hs') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_hs">Hair Spray</a></li>
									<li <?php if($hccat=='s_hc') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=s_hc">Hair Color</a></li>
									<li <?php if($hccat=='repair') echo 'class="m_active"';?>><a href="http://hairlibrary.com/quick-match/?cat=repair">Hair Care/Repair</a></li>									
								</ul>
							</div>
