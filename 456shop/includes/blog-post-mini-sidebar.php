		...
		<?php $share = get_post_meta($post->ID, 'share_value', true);?>
						...
						<div class="post mini span6 one-column <?php $allClasses = get_post_class(); foreach ($allClasses as $class) { echo $class . " "; } ?>">
							<div class="shadow-s3">
								<?php if ( (function_exists('has_post_thumbnail')) && (has_post_thumbnail()) ) {?>
									<div class="effect-thumb <?php if (!$share){?>effect-thumb-2<?php }?>">
			                    ...
			                    <?php } elseif ( $videoURL ) {?>
			                    	<iframe class="scale-with-grid" width="620" height="349" src="<?php echo $videoURL ?>?wmode=transparent;showinfo=0" frameborder="0" allowfullscreen></iframe>
			                    <?php }?>
								<div class="content">
									<div class="post_type">
										<div class="icon 
