<html><!-- InstanceBegin template="/Templates/resp1.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
<!-- #EndEditable -->
</head>
<body text="#000000" id="">
...
<div id="wrapper">
      ...
      <div id="content"><!-- google_ad_section_start -->
        ...
        <h1 >Calorie Calculator - Daily Calorie Needs</h1>
 ...
 <form name="calc" >
          <table class="tooltable" style="margin-top:5px;width:100%;" border="0" cellpadding="2" cellspacing="0" >
              <tr>
              ...
              <tr>
                ...
                <td ><input name="weight"  type="text" id="weight" size="3" maxlength="3">
...
<!--                     <tr>
 ...
 -->                  </table>
   ...
   <div class="toolbox group">
      <div class="share" style="margin-top:10px;"><a href="http://pinterest.com/pin/create/button/?url=http%3A//www.freedieting.com/tools/calorie_calculator.htm&media=http%3A//www.freedieting.com/images/pin/how-to-calculate-calories-2.jpg&description=Calculates%20your%20daily%20calories%2C%20along%20with%20a%207-day%20zig-zag%20plan." class="pin-it-button" count-layout="vertical"><img border="0" alt="pin it" src="//assets.pinterest.com/images/PinExt.png" title="Pin It" /></a></div>
...
<li><a class="" style="text-decoration:none;" href="#" onClick="toggleMe(this,'morecalc');return false;"> <img style="border:0; " alt="triangle" src="../images/widget_triangle_open.gif" >More...</a></li>
</ul>
