...
<?php if ( ! $product->is_in_stock() ) : ?>
	...
	<a href="<?php echo apply_filters( 'out_of_stock_add_to_cart_url', get_permalink( $product->id ) ); ?>" class="button"><?php echo apply_filters( 'out_of_stock_add_to_cart_text', __( 'Read More', GETTEXT_DOMAIN ) ); ?></a>
	...
	<?php
		...
		switch ( $product->product_type ) {
			...
			case "external" :
				...
				$label 	= apply_filters( 'external_add_to_cart_text', __('Read More', GETTEXT_DOMAIN) );
			break;
			default :
