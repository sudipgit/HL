<?php
/*
Template Name: 2 Column Portfolio (sidebar)
*/
?>
<?php get_header(); ?>
<?php $left_sidebar = get_post_meta($post->ID, 'left_sidebar_value', true);?>
		...
		<?php endwhile; endif; ?>
		<?php if ($left_sidebar){?>left-sidebar-template<?php }?>">
			<div class="container">
				...
				<div class="row-fluid">
					...
					<div class="span8 post-page portfolio-2">
								...
								<div class="content">
									...
									<div class="portfolio-categories">
	                                    ...
	                                    <?php if($terms) : foreach ($terms as $term) { ?>
	                                        <?php $resultstr[] = '<a rel="tooltip" class="ttip" data-placement="bottom" title="'.$term->name.'" href="'.get_term_link($term->slug, 'portfolio_category').'">'.$term->name.'</a>'?>
	                                    <?php } ?>
