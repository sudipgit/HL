<?php
/*
   Template Name: Salon List Landing2
 ...
 ?>
		...
		<div id="main" class="salons">
			<div class="banner-salon">
				...
				<div class="banner-text desktop-display">
					<h2 class="banner-text-title">The World's Hair Product Matching Resource</h2>
					<h2 class="banner-text-description">Get Matched With Hair Products Based On Your Hair Type & Texture<br>Discover. Connect. Share.</h2>
					<form action="http://HairLibrary.com/" method="get" role="search" class="location-search form-home-search">
				...
				<div class="banner-text mobile-display">
					<h2 class="banner-text-title">The World's Hair Product Matching Resource</h2>					
				</div>
			</div>
			<div class="container"> 
				<div class="text-center mt-30 mb-30">
					...
					<p class="desktop-display" style="color:#717a8f;font-size:16px;padding-bottom:40px;">Hair Library is the world’s largest hair texture based product matching information resource and growing. We make the process of finding hair products, brand information and inspiration hair stories for you fast and simple. Check out reviews of brands, products, and hair stories from the community to ensure you make the best, most informed selection for your unique hair needs.&#8203;</p>
					<p class="mobile-display" style="color:#717a8f;font-size:16px;padding-bottom:40px;">Hair Library is the world’s largest hair texture based product matching information resource and growing. We make the process of finding hair products, brand information and inspiration hair stories for you fast and simple.</p>
					<a href="http://hairlibrary.com/register/" class="button btn primary">Discover Your Match</a>
				</div>
				<div class="text-center mt-60 mb-30">
					<h2 class="block-title">Explore Hair Library By Category</h2>
					<h2 class="block-subtitle">See What New Products Have Been Added To The Library.</h2>
				</div>
				<div class="row-fluid">	               
					<div class="span8">
					...
					<div class="span4">
						<a class="community-section-hover" href="#">
							<div class="community-section">
								...
								<img src="<?php bloginfo('template_url');?>/assets/img/salon-list/2/Conditioner.png">							
								<div class="info">
									<p>Conditioner</p>
								</div>
						...
						<div class="row-fluid">	 
							<div class="span7">
								...
								<div class="community-section">
										...
										<img src="<?php bloginfo('template_url');?>/assets/img/salon-list/2/tools.png">							
										<div class="info">
											<p>Tools</p>
										</div>
				...
				<div class="container">
				<div class="text-center mt-80  mb-30">
					<h2 class="block-title">Featured Hair Library Products</h2>
					<h2 class="block-subtitle">Notable Products On Hair Library</h2>
				</div>
			...
			<div class="row-fluid  mb-20">
				<div class="span12 inspired-section">
					...
					<div class="video-embed">
						<iframe class="desktop-display" src="https://player.vimeo.com/video/98210665" height="580" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
						<iframe class="mobile-display" src="https://player.vimeo.com/video/98210665" height="200" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
					</div>
				</div>
			</div>
			<div class="container"> 
