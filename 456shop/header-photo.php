...
$photo=getPhotoDetails($id);
       ...
       $img ='http://hairlibrary.com/wp-content/uploads/photostore/'.$photo->user_id.'/'.$photo->photo;
      $excerpt = implode(' ', array_slice(explode(' ', getFormatedDes($photo->description)), 0, 30));

     $excerpt=str_replace('"',"",$excerpt);
	 
	 // $excerpt.='<br>Hair Library, The World\'s Premier Online Beauty Destination';
...
<meta name="author" content="Hair Library" />
	<meta property="og:title" content="<?php echo getFormatedDes($photo->title);?>" />
<meta property="og:description" content="<?php echo $excerpt;?>" />
<meta property="og:image" content="<?php echo $img;?>" />
<meta property="og:url" content="http://hairlibrary.com/hairstory/?n=<?php echo $photo->slug;?>&user=<?php echo $puser_info->user_login;?>&brand=<?php echo $brand->company_slug;?>&p=<?php echo $product->post_name;?>">
