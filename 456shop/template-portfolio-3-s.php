<?php
/*
Template Name: 3 Column Portfolio (sidebar)
*/
?>
<?php get_header(); ?>
<?php $left_sidebar = get_post_meta($post->ID, 'left_sidebar_value', true);?>
		...
		<?php if ($left_sidebar){?>left-sidebar-template<?php }?>">
			<div class="container">
				...
				<?php endwhile; endif; ?>
				<div class="row-fluid">
					<div class="span8 post-page portfolio-3">
                	...
                	<div id="container" class="portfolio clearfix">
						...
						<div class="element post portfolio span4 <?php if($terms) : foreach ($terms as $term) { echo ''.$term->slug.' '; } endif; ?>">
							<div class="shadow-s3">
								<?php if ( $lightbox ) { ?>
