...
<link rel="stylesheet" href="<?php bloginfo('url'); ?>/wp-content/themes/456shop/assets/css/sign-up.css" />
</head>
  ...
  <div class="user-register">
      ...
      <div class="box-content">
		...
		<div class="logo">
			...
			<a href="<?php bloginfo('url');?>"><img src="<?php bloginfo('template_url');?>/assets/img/hl_logob.png" width="250" alt="Logo" /></a>
		</div>
		<div class="questions-nav">
			<ul id="question-list" class="center-nav">
				<li id="question-1-nav" class="question-nav current ">
					<a  href="javascript:void();">Style</a>
					<span id="qAnswerText1" class="question-answer-nav"> </span>
				</li>
				<li id="question-2-nav" class="question-nav ">
					<a href="javascript:void();"> Length</a>
					<span id="qAnswerText2" class="question-answer-nav"> </span>
				</li>
				<li id="question-3-nav" class="question-nav">
					<a href="javascript:void();">Texture</a>
					<span id="qAnswerText3" class="question-answer-nav"> </span>
				</li>
				<li id="question-4-nav" class="question-nav">
					<a href="javascript:void();">Hair Process</a>
					<span id="qAnswerText4" class="question-answer-nav"> </span>
				</li>
				<li id="question-5-nav" class="question-nav">
					<a href="javascript:void();">Color</a>
					<span id="qAnswerText5" class="question-answer-nav"> </span>
				</li>
				<li id="question-6-nav" class="question-nav">
					<a href="javascript:void();">Condition</a>
					<span id="qAnswerText7" class="question-answer-nav"> </span>
				</li>
				<li id="question-7-nav" class="question-nav">
					<a href="javascript:void();">Description</a>
					<span id="qAnswerText8" class="question-answer-nav"> </span>
				</li>
				<li id="question-8-nav" class="question-nav">
					<a href="javascript:void();">Demographic</a>
					<span id="qAnswerText9" class="question-answer-nav"> </span>
				</li>
		...
		<div class="container">
	       <div class="form-des">
		     <p class="bigger">Create Your HAIR PROFILE TO GET MATCHED WITH PRODUCTS THAT ARE MADE WITH YOU IN MIND!
</p>
		     <p class="small">COMPLETE YOUR HAIR PROFILE AND WE CAN MATCH YOU WITH PRODUCTS YOU  LIKE So you can spread the LOVE!</p>
		    </div>
		  
		    <div class="panel-holder">
			<div class="inner-holder" id="in-h" style="<?php if($f_post) echo 'height: 800px;'; else echo 'height: 500px;';?>">
			 <div id="panel-content" style="visibility: visible; width: 8170px; <?php if($f_post) { echo 'left: -7114px;height:645px;';} else { echo 'left: 0px;height:360px;';}?>">
			  ...
			  <form name="user-register" action="" method="post" onsubmit="return formValidation();">
			    <!-- panel1 Hair Category --> 
				 ...
				 <p class="hair-type pink">What is your Hair Style?</p>
				   <div class="question-images" style="width:620px;">
				...
				<!-- panel2 Hair Category --> 
				 ...
				 <p class="hair-type pink">What is your hair Length?</p>
				   <div class="question-images" style="width:752px;">
				    <ul>
					  <li>
				...
				<a href="javascript:void();" class="prev-button" onclick="prev_button(1,500,360,1)" >Back</a>
				 </div> 
				...
				<!-- panel3 Hair Category --> 
				 ...
				 <p class="hair-type pink">What is your Hair Texture?</p>
				   <div class="question-images" style="width:780px;">
				    <ul>
					  <li id="texture-st">
				    ...
				    <a href="javascript:void();" class="prev-button" onclick="prev_button(881,410,260,2)" >Back</a>
				 </div> 
	            <!-- panel3 Hair Category End --> 
				
				<!-- panel4 Hair Category --> 
                 <div class="panel panel4">
				 <p class="hair-type pink">What Chemical Treatments Do You Have?</p>
				   <div class="question-images" style="width:620px;">
				    <ul>
					...
					<div class="clear"></div>
				     ...
				     <a href="javascript:void();" class="prev-button" onclick="prev_button(1762,560,420,3)" >Back</a>
				 </div> 
				...
				<!-- panel4 Hair Category --> 
				 ...
				 <p class="hair-type pink">Is your hair colored ?</p>
				   <div class="question-images" style="width:310px;">
				    <ul>
					...
					<div class="clear"></div>
				     ...
				     <a href="javascript:void();" class="prev-button" onclick="prev_button(2643,560,420,4)" >Back</a>
				 </div> 
	            <!-- panel4 Hair Category End --> 
				...
				<!-- panel5 Hair Category --> 
				 ...
				 <p class="hair-type pink">What Are Your Hair Conditions?</p>
				   <div class="question-images" style="width:620px;">
				    <ul>
					  <li >
				    ...
				    <a href="javascript:void();" class="prev-button" onclick="prev_button(3524,410,260,5)" >Back</a>
					 <a style="margin-left:40px" href="javascript:void();" class="prev-button" onclick="nextCond()" >Next</a>
				 </div> 
				...
				<!-- panel5 Hair Category --> 
				 ...
				 <p class="hair-type pink">How Would Your Describe Your Hair?</p>
				   <div class="question-images" style="width:620px;">
				    <ul>
					  <li >
				    ...
				    <a href="javascript:void();" class="prev-button" onclick="prev_button(4405,560,420,6)" >Back</a>
					 <a style="margin-left:40px;" href="javascript:void();" class="prev-button" onclick="nextDes()" >Next</a>
				 </div> 
				 ...
				 <p class="hair-type pink">What is your Demographic?</p>
				   <div class="question-images" style="width:638px;">
				    <ul>
					  <li>
					...
					<div class="clear"></div>
				      ...
				      <a href="javascript:void();" class="prev-button" onclick="prev_button(5286,560,420,6)" >Back</a>
				 </div> 
				...
				<input type="submit" class="button" value="Submit" style="margin-right: 30%;"/>
				</div>
				   <a href="javascript:void();"class="prev-button" onclick="prev_button(6300,410,260,7)" >Back</a>
				 </div> 
