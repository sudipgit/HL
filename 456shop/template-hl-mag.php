...
<div class="container">
		  ...
		  <h3 style=" color: #fff;position: absolute;text-align: center;text-transform: capitalize;top: 15%;width: 100%;"><span style="font-size:36px";>Welcome To HL Mag!</span> <br>Enjoy curated hair articles from around the world.</h3>
	     <img src="http://HairLibrary.com/wp-content/uploads/2015/04/2012-02-03_006.jpg">
		 </div>
		 	<div class="row-fluid">
		<div class="span8 left_side_content">
			<div class="editors_picks">
				<h4> Featured Librarian</h4>
				<a href="http://hairlibrary.com/collections/beauty-influencer-nicole-forson-walters/"><img src="http://HairLibrary.com/wp-content/uploads/2015/04/DSCN0859.jpg"></a>
			...
			<div class="featured-brands">
				<h2  class="block-title">Featured Brands</h2>
                  ...
                  <div class="desktop-display" style="margin-top:-20px;"><?php if( function_exists('cyclone_slider') ) cyclone_slider('home-page-popup-shop'); ?></div>
		...
		<div class="span4 right_sidebar">
			<div class="title"><h4 style="width:134px;">Good Reads</h4></div>
			<div class="row-fluid">
				<div class="span12">
					<ul>	
		    					
						<li><a href="<?php bloginfo('url');?>/feeds/hair-extensions">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/rapunzel-editorial1-980x400.jpeg"/>
                             </a>							
							<div class="text_path">
						...
						<li><a href="<?php bloginfo('url');?>/feeds/curly-hair/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/curlyhair1-977x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3>Curly Hair</h3>
		         ...
		         <li><a href="<?php bloginfo('url');?>/feeds/hair-loss/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/thin-hair-976x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3> Thin Hair</h3>
                      ...
                      <li><a href="<?php bloginfo('url');?>/feeds/hair-removal/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/hairy-2-1170x400.png"/>
                             </a>							
							<div class="text_path">
								<h3>Hair Removal</h3>
                    ...
                    <li><a href="<?php bloginfo('url');?>/feeds/hair-color/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/hair-color-feeds-980x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3>Hair Color</h3>
                      ...
                      <li><a href="<?php bloginfo('url');?>/feeds/barber/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/grooming-feed-973x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3>Barber</h3>
						...
						<li><a href="<?php bloginfo('url');?>/feeds/short-hair/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/short-hair-978x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3>Short Hair</h3>
						...
						<li><a href="<?php bloginfo('url');?>/feeds/natural-hair/">
								<img src="http://HairLibrary.com/wp-content/uploads/2014/10/natural-hair--980x400.jpg"/>
                             </a>							
							<div class="text_path">
								<h3>Natural Hair</h3>
